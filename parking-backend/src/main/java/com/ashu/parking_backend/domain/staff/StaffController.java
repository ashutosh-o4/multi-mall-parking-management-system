...
public class StaffController {
    ...
    public ResponseEntity<ApiResponse<StaffResponse>> createStaff(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(
                        staffService.createStaff(request,creator.getId()),"Staff created successfully")
                );
    }
    ...
    public ResponseEntity<ApiResponse<StaffResponse>> updateStaffStatus(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(staffService.updateStaffStatus(id,request),"Staff status updated successfully")
        );
    }
